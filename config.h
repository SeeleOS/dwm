...
static const char *colors[][3] = {
    ...
    [SchemeInfoSel]  = { col_fg_sel, col_muted, col_muted  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg, "-nf", col_fg, "-sb", col_accent, "-sf", col_fg_sel, NULL };
